...
export default function Users(){
  const [f,setF]=useState({page:1,limit:20});const r=useResource('/customers',f,true);const staff=useResource('/integrations/staff',{role:'telecaller',status:'active'});
