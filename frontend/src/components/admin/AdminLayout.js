...
const nav=[['','Overview',['admin']],['users','Customers',['admin']],['staff','Staff directory',['admin']],['queries','Pending Queries',['admin','telecaller','billing_executive']],['leads','Lead CRM',['admin','telecaller']],['winback','Win-back & Churn',['admin','telecaller']],['rates','Rates & Slabs',['admin','billing_executive']],['products','Collections',['admin']],['catalog-author','Catalog authoring',['admin']],['pdf-import','Reviewed PDF import',['admin']],['batches','Batches',['admin']],['banners','Banners',['admin']],['rewards','Rewards & Billing',['admin','billing_executive']],['content','App content',['admin']],['media','Media usage',['admin']],['settings','Settings & Privacy',['admin']],['account','My account',['admin','telecaller','billing_executive']]];
