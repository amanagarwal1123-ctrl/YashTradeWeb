...
- Backlog: real Play Store / App Store links; admin alert (SMS/WhatsApp) on each new enrollment; confirm production LIVE_BACKEND_BASE; app team to implement integration endpoint.
