...
- Backlog: real Play Store / App Store links (env ANDROID_APP_URL / IOS_APP_URL already read by /api/public/config; user to supply URLs); admin alert on each new enrollment; admin live-modules unlock now that demo mode is off.
